  ...
  const steps = [
    {
      ...
      description: "Create an account or log in. Build a personalized profile that tracks your interview journey and stores preferences."
    },
    {
    ...
    <div className="container mx-auto px-4 py-12">
      <div className="text-center mb-12">
        <h1 className="text-4xl font-bold text-gray-800 mb-4">
          ...
          MockCraft: Your Interview Preparation Companion
        </h1>
